package com.connect_group.performance_testing.config;
...
import com.connect_group.performance_testing.thymeleaf.PerformanceTestingDialect;
import com.connect_group.performance_testing.thymesheet.SpringBootThymesheetTemplateModeHandler;
...
public class SpringBootThymesheetConfig {
	...
	public SpringThymesheetTemplateEngine templateEngine() {
		...
		additionalDialects.add(new PerformanceTestingDialect());
